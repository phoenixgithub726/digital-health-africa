...
const Content = ({ele, showComment, disabled, ableComment}) => {
    ...
    return(
            <Paper className={classes.paper} key={'recent_quiz' + ele.id}>
                ...
                {
                    ableComment &&
                    <Grid container item xs={12} justify='flex-start' style={{padding:'6px 8px', marginTop: '20px'}}>
                        <ThumbUpIcon onClick={handleLike} style={{color: like? 'red' : 'gray'}}/>
                            {likeNum}
                        <VisibilityIcon style={{color: 'gray', marginLeft: '20px'}}/>
                            {ele.views}
                        <Button 
                            style={{padding:'0px', marginLeft: '20px', color: comment? 'blue' : 'gray'}}
                            onClick={handleClick}
                            disabled={disabled}
                        ...
                        <Button 
                            style={{padding:'0px', marginLeft: '20px', color: follow? 'blue' : 'gray'}}
                            onClick={handleFollow}
                            disabled={disabled}
                            startIcon={follow? <CheckIcon style={{color:'blue'}}/> :<AddBoxIcon style={{color:'gray'}}/>}
                        >
                            {
